    ...
    return (
        <section className='presentacion'>
            ...
            <div className='container-texto'>
                ...
                <p>Con un enfoque en la atención al cliente y la calidad de nuestros productos, rápidamente ganamos popularidad. Nuestra combinación de estilo, accesibilidad y un fuerte sentido de comunidad atrajo a un público fiel y creciente. Hoy, nuestra tienda es un testimonio de lo que puede lograrse con determinación, amistad y una visión compartida.</p>
            </div>
        </section>
    )
}
